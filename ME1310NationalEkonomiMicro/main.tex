...
\newpage
\section*{Föreläsning 6: Sammanfattning}
Överblick över mikroekonomi:
\begin{itemize}
    \item Konsumentteori: Enskilda konsumenters beteende
    \item Konsumtionsval: Hur konsumenter väljer mellan olika varor och tjänster
    \item Producentteori: Enskilda företags beteende
    \item Produktionsval: Hur företag väljer mellan olika produktionsfaktorer och produktionsnivåer
    \item Marknadsformer: Perfekt konkurrens och monopol
\end{itemize}

\subsection*{Konsumenternas optimala konsumptionsval}
\begin{itemize}
    \item Budgetrestriktion -- Kombinationer av varor som kostar lika mycket
    \begin{itemize}
        \item Beror på priser och inkomst
        \item Ser ut som en nedåtlutande rätlinje
    \end{itemize}
    \item Indifferenskurvor -- Kombinationer av varor som ger samma nytta
    \begin{itemize}
        \item Preferenser
        \item Nyttofunktion reflekterar hur mycket nytta en konsument får av olika varokombinationer
    \end{itemize}
    \item Konsumenten vill maximera nytta givet sin budgetrestriktion
    \item Optimum nås vid tangering mellan budgetrestriktion och indifferenskurva
\end{itemize}

\subsection*{Producenternas optimala produktionsval}
\begin{itemize}
    \item Isokost -- Kombinationer av produktionsfaktorer som kostar lika mycket
    \begin{itemize}
        \item Två faktorer -- Arbetskraft och kapital
        \item Rätlinje som visar alla kombinationer av faktorer som kostar lika mycket
    \end{itemize}
    \item Isokvant -- Kombinationer av produktionsfaktorer som ger samma produktion
    \begin{itemize}
        \item Böjd kurva 
        \item Företaget vill hitta där isokosten tangerar isokvanten 
        \item Målet är att minimera kostnaden för att producera en given mängd varor
    \end{itemize}
\end{itemize}

\subsection*{Externaliteter}
I en marknad möter konsumenter och producenter varandra och gör transaktioner
\begin{itemize}
    \item Negativ externalitet: Kostnader som påverkar tredje part som inte är inblandade i transaktionen
    \item Positiv externalitet: Nytta som påverkar tredje part som inte är inblandade i transaktionen
\end{itemize}

Exempel:
\begin{itemize}
    \item Negativ externalitet: Utsläpp från en fabrik påverkar andra aktörer negativt
    \item Positiv externalitet: Honungsproduktion som gynnar både biodlaren och bönderna som har nytta av pollineringen
\end{itemize}

Staten kan reglera externaliteter:
\begin{itemize}
    \item Negativ externalitet: Införa skatter eller kvoter för att minska produktionen av varan
    \item Positiv externalitet: Införa subventioner eller stöd för att öka produktionen av varan
\end{itemize}

\subsection*{Sammanfattaning av alla 6 föreläsningar}
\begin{enumerate}
    \item Efterfrågan, utbud, marknadsjämnvikt, elasticitet
    \item Konsument- och producentöverskott, presrestritktioner, skatter, subventioner
    \item Preferenser, nyttofunktioner, indifferenskurvor, budgetrestriktioner, marginella substitutionskvoten
    \item Inkomst- och priseffekter, substitut och komplement, aggregerad efterfrågekurva
    \item Produktionsfunktion, kostnader och produktionsbeslut på kort och lång sikt, isokost, isokvant, teknisk substituionskvot, skalavkastning
    \item Marknadsformer: perfekt konkurrens, monopol och externaliteter
\end{enumerate}

\subsection*{1. Utbud/efterfrågan och jämvikt}
Efterfrågan:
\begin{itemize}
    \item Vad bestämmer efterfrågan?
    \item Efterfrågekruva/Invers efterfrågekurva
    \item Pris effekt:
    \begin{itemize}
        \item Normala varor -- Efterfrågan minskar när priset ökar
        \item Giffenvaror -- Efterfrågan ökar när priset ökar
    \end{itemize}
    \item Inkomst effekt:
    \begin{itemize}
        \item Normala varor -- Efterfrågan ökar när inkomsten ökar
        \item Inferiora varor -- Efterfrågan minskar när inkomsten ökar
    \end{itemize}
    \item Subsitut och komplement:
    \item Varför och hur skfiter kurvan 
\end{itemize}

Utbud:
\begin{itemize}
    \item Vad bestämmer utbudet?
    \item Utbudskurva/Inverterad utbudskurva
    \item Varför och hur skfiter kurvan
\end{itemize}
...
\begin{itemize}
    \item Saxen
    \item Efterfrågeöverskott och utbudöverskott
    \item Hur nås jämvikt?
    \item Komparativ statik
    \item Kurvskiften: Hur påverkas pris och jämvikt
\end{itemize}

Elasticitet:
\begin{itemize}
    \item Taxonomi --- Priselasticitet, inkomstelasticitet, korselasticitet
\end{itemize}

\subsection*{2. Konsument- och producentöverskott}
Hur påverkas överskotten av föränderingar:
\begin{itemize}
    \item Kvantitetsregleringar
    \item Skatter
    \item Subventioner
\end{itemize}
Överskott beskriver hur mycket en aktör tjänar på att det finns en marknad

\subsection*{3. Konsumentteori}
Preferenser:
\begin{enumerate}
    \item Komplette
    \item Mer är bättre
    \item Transitivitet
    \item Avtagande relativt bytesförhållande
\end{enumerate}
Viktiga komponenter:
\begin{itemize}
    \item Nyttofunktioner
    \item Indifferenskurvor -- MRS
    \item Budgetrestriktioner
    \item Nyttomaximering -- MRS = Lutningen på budgetrestriktion
\end{itemize}

\subsection*{4. Individens och marknadens efterfråga}
Inkomständring och optimalt konsumtionsval:
\begin{itemize}
    \item Normal / inferiör vara
    \item Income expansion path
    \item Engelkurva
    \item Inkomstelasticitet
\end{itemize}

Prisförändring och optimalt konsumtionsval:
\begin{itemize}
    \item Individens efterfrågekurva
\end{itemize}

Andra viktiga komponenter:
\begin{itemize}
    \item Inkomst och substituionseffekt
    \item Aggregering och marknadens efterfrågekurva
\end{itemize}

\subsection*{5. Producentteori}
Antaganden:
\begin{enumerate}
    \item Varje företag producerar en produktsort
    \item Företaget har valt sin produkt
    \item Företagets mål är att minimera kostnaden givet producerad kvantitet
    \item Två produktionsfaktorer: Arbetskraft och kapital  
    \item Fix kapitalstock på kort sikt men på lång sikt är både kapital och arbetskraft rörliga
    \item Positiv marginalavkastning (marginalproduktivitet) på arbetskraft och kapital
    \item Avtagande marginalavkastning på produktionsfaktorerna
    \item Obegränsad tillgång till produktionsfakorerna till fixa priser
    \item Företaget har inga finansiella begränsningar
\end{enumerate}

\noindent Produktionsfunktion:
\begin{itemize}
    \item Iskovant -- MRTS
    \item Isokost
    \item Kostnadsminimering -- MRTS = letningen på isokosten
\end{itemize}

\noindent Skalavkastning:
\begin{itemize}
    \item CRTS
    \item IRTS
    \item DRTS
...
\noindent Vi kan också modellera teknologisk förändering
\vspace{10pt}
\noindent Kostnader:
\begin{itemize}
    \item Alternativkostnad
    \item Sunk costs
\end{itemize}
\noindent Kostnadskurvor:
\begin{itemize}
    \item $TC = VC + FC$
    \item $ATC = AVC + AFC$
    \item $MC = \frac{dTC}{dQ}$
    \item Relation mellan $MC$ och $ATC$, $AVC$
    \item Relation mellan expansion path och $TC$
\end{itemize}

\subsection*{6. Marknadsformer -- perfekt konkurrens}
\begin{itemize}
    \item Enskilda företag är pristagare och kan inte påverka marknadspriset
    \item Vinstmaximering: $P = MC$
\end{itemize}

Utbudskurva:
\begin{itemize}
    \item Kort sikt -- $MC > AVC$
    \item Lång sikt -- $MC > ATC$
\end{itemize}

\noindent Producentöverskott:
\begin{itemize}
    \item $\int_{0}^{Q^*} (P - MC) dQ$
    \item $(P - AVC^*) \cdot Q^*$
\end{itemize}

\noindent Positiva vinster och entry:
\begin{itemize}
    \item Entry och horisontell långsiktig utbudskurva, $P = min LATC$
\end{itemize}

\subsection*{Marknadsformer -- monopol}
Marknadskraft och prissättning
\begin{itemize}
    \item Kan påverka marknadspriset
    \item Måste sänka priset för att sälja mer
    \item Lerners index
\end{itemize}

\noindent I monopol gäller
\begin{itemize}
    \item Vinstmaximering: $MR = MC$
\end{itemize}
...
\begin{itemize}
    ...
    \item Konsekvens
    \begin{itemize}
        \item Det produceras för mycket (negativ externalitet) eller för lite (positiv externalitet) av varan
        \item DWL -- Dödsviktskostnad
    \end{itemize}
\end{itemize}

Staten kan invervenera i marknaden genom:
\begin{itemize}
    \item Skatter
    \item Subventioner
    \item Restriktioner
